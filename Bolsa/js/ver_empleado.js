...
const fetchCosas = async () => {
    ...
    let empleado = await (await fetch("http://localhost:3000/empleado/get/" + params.id, optionsEmpleado)).json();
    ...
    let estudios = await (await fetch("http://localhost:3000/estudios/get/" + params.id, optionsEstudios)).json();
    ...
    let experiencia = await (await fetch("http://localhost:3000/experiencia/get/" + params.id, optionsExperencia)).json();
    ...
    let idioma = await (await fetch("http://localhost:3000/idioma/get/" + params.id, optionsIdioma)).json();
    ...
    buscarEmpleo.innerText = "Buscar Empleado";
    ...
    if (estudios[0].consulta != "no") {
        ...
        let estudios__titulo = (document.getElementById(
            "titulo-estudios"
        ).innerText = "Solo cuenta con estudios primarios");
